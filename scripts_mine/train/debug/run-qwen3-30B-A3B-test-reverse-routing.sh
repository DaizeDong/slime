...
# Example script demonstrating the reverse routing replay order feature
# This script shows how to enable the experimental feature where:
...
export run_postfix="reverse-routing"  # Mark this as a reverse routing experiment
...
CKPT_ARGS=(
  ...
  # IMPORTANT: Must enable keep-old-actor for reverse routing replay
  --keep-old-actor
)
...
# ===============================================
# REVERSE ROUTING REPLAY CONFIGURATION
# ===============================================
ROUTING_REPLAY_ARGS=(
  # Enable routing replay (required)
  --use-routing-replay
  
  # Enable reverse order (experimental feature)
  --reverse-routing-replay-order
  
  # Debug: save intermediate data for verification
  --save-debug-rollout-data /mnt/sharefs/users/haolong.jia/RL-data/DEBUG/reverse-routing/dapo-math_{rollout_id}.pt
  --save-debug-train-output /mnt/sharefs/users/haolong.jia/RL-output/DEBUG/reverse-routing/dapo-math_output_{rollout_id}_{rank}.pt
)
# ===============================================
